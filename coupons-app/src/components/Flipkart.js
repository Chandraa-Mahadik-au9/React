...
import FlipkartVoucher from '../assets/flipkart.jpg';
...
const Amazon = () => {
    ...
    const validateCoupon = (event) => {
        ...
        if(currentTime < generatedTime) {
            ...
            console.log(`Flipkart Coupon: ${CouponName} is successfully applied.`);
        } else {
    ...
    return (
        <div>
            <h1>Hi, welcome To Flipkart</h1>
            <br />
            <div>
                <img src={FlipkartVoucher} alt="flipkart voucher" />
            </div>
            <br />
            <div>
                <form>
                    <label htmlFor="qrCode">Your Flipkart Coupon Code : </label>
